...
import TestimonialImage04 from '@/public/images/a62e33adca57d2d2e50e19f7e2d9944c.jpg'
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="400">
              ...
              <blockquote className="text-lg text-gray-400 grow">You will be satisfied with cheap price and high quality. You are free to decorate interior.</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Ephraim Spice</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Home Owner</a>
              </div>
            </div>
